...
const PUB_CATEGORIES = [
  ...
  { id: "lhc",        name: "ATLAS Searches with Machine Learning" },
];
...
/* ---------------------------------------------------------------------------
   5. PUBLICATIONS
   ------------------------------------------------------------------------
   Put the group's authors in bold by wrapping the name in *asterisks*,
   e.g.  "A. Author, *T. Golling*, B. Author".
...
const PUBLICATIONS = [
  ...
  },
  {
    category: "lhc",
    year: 2026,
    title: "Search for Beyond the Standard Model physics with anomaly detection in multilepton final states in pp collisions at √s=13 TeV with the ATLAS detector",
    authors: "ATLAS Collaboration",
    journal: "Eur.Phys.J.C 86, 247 (2026)",
    citations: 4,
    arxiv: "https://arxiv.org/abs/2508.19778",
    doi: "https://doi.org/10.1140/epjc/s10052-025-15218-2",
    inspire: "https://inspirehep.net/literature/2964453",
    bibtex: `@article{ATLAS:2025cdi,
  title   = {{Search for Beyond the Standard Model physics with anomaly detection in multilepton final states in pp collisions at $\\sqrts=13~\\textrmTeV$ with the ATLAS detector}},
  author  = {{ATLAS Collaboration}},
  ...
  },
  {
    ...
    authors: "ATLAS Collaboration",
    journal: "Phys.Rev.Lett. 132, 081801 (2024)",
    citations: 75,
    star: true,
    arxiv: "https://arxiv.org/abs/2307.01612",
    doi: "https://doi.org/10.1103/PhysRevLett.132.081801",
    inspire: "https://inspirehep.net/literature/2674351",
    bibtex: `@article{ATLAS:2023ixc,
  title   = {{Search for New Phenomena in Two-Body Invariant Mass Distributions Using Unsupervised Machine Learning for Anomaly Detection at <math display="inline"><mrow><msqrt><mrow><mi>s</mi></mrow></msqrt><mo>=</mo><mn>13</mn><mtext> </mtext><mtext> </mtext><mi>TeV</mi></mrow></math> with the ATLAS Detector}},
  author  = {{ATLAS Collaboration}},
  ...
  },
  {
    ...
    authors: "ATLAS Collaboration",
    journal: "JINST 18, P11006 (2023)",
    citations: 39,
    arxiv: "https://arxiv.org/abs/2306.09738",
    doi: "https://doi.org/10.1088/1748-0221/18/11/P11006",
    inspire: "https://inspirehep.net/literature/2669599",
    bibtex: `@article{ATLAS:2023gog,
  title   = {{Fast b-tagging at the high-level trigger of the ATLAS experiment in LHC Run 3}},
  author  = {{ATLAS Collaboration}},
  journal = {JINST},
  volume  = {18},
  ...
  },
  {
    ...
    authors: "ATLAS Collaboration",
    journal: "Phys.Rev.D 108, 052009 (2023)",
    citations: 69,
    star: true,
    arxiv: "https://arxiv.org/abs/2306.03637",
    doi: "https://doi.org/10.1103/PhysRevD.108.052009",
    inspire: "https://inspirehep.net/literature/2666488",
    bibtex: `@article{ATLAS:2023azi,
  title   = {{Anomaly detection search for new resonances decaying into a Higgs boson and a generic new particle $X$ in hadronic final states using $\\sqrts = 13$ TeV $pp$ collisions with the ATLAS detector}},
  author  = {{ATLAS Collaboration}},
  journal = {Phys.Rev.D},
  volume  = {108},
  year    = {2023},
